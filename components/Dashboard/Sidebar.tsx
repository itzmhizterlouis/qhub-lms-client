...
const Sidebar = () => {
  return (
    <aside className="col-span-2 bg-primary-light/50 py-6 text-black h-screen justify-between flex flex-col ">
      <div>
        ...
        <ul className="mt-8 flex flex-col items-start ">
          {sidebar.map((item, index) => (
            <li
              key={index}
              className="flex items-center px-10 gap-4 font-semibold justify-center py-4"
            >
